...
import { ArrowDown, Download, Mail, Phone, MapPin, Github, Linkedin, ExternalLink, Code, Database, Globe, Smartphone, Award, Calendar, GraduationCap, Building, CheckCircle, Star, Palette, Image, PenTool, Share2, Video, TrendingUp, Loader2 } from 'lucide-react';
...
const Portfolio = () => {
  ...
  // Cursor-follow highlight for the Skills text block
  ...
  const validateForm = () => {
    ...
    if (!formData.email.trim() || !validateEmail(formData.email)) newErrors.email = 'Please enter a valid email.';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm()) {
      toast({
        ...
        description: 'Double-check your email and message length.',
        variant: 'destructive',
      });
      return;
    }
  ...
  const skillCategories = {
    "Programming Languages": [
      ...
      { name: 'Python', level: 70, icon: Code, description: 'Advanced' },
      { name: 'TypeScript', level: 75, icon: Code, description: 'Advanced' },
      { name: 'C++', level: 60, icon: Code, description: 'Intermediate' },
    ],
    "Web Technologies": [
      { name: 'HTML', level: 90, icon: Globe, description: 'Expert' },
      { name: 'CSS', level: 88, icon: Globe, description: 'Expert' },
      { name: 'RESTful APIs', level: 80, icon: Database, description: 'Advanced' },
      { name: 'JSP/Servlets', level: 70, icon: Code, description: 'Advanced' },
      { name: 'Responsive Design', level: 90, icon: Smartphone, description: 'Expert' },
    ],
    "Frameworks & Libraries": [
      { name: 'React', level: 80, icon: Code, description: 'Advanced' },
      { name: 'Redux', level: 70, icon: Code, description: 'Advanced' },
      { name: 'Spring Boot', level: 75, icon: Code, description: 'Advanced' },
      { name: 'Tailwind CSS', level: 85, icon: Code, description: 'Advanced' },
      { name: 'Bootstrap', level: 80, icon: Code, description: 'Advanced' },
    ],
    "Design & Creative": [
      ...
      { name: 'Figma', level: 80, icon: Palette, description: 'Advanced' },
    ],
    "Content Creation": [
      ...
      { name: 'SEO Blogging', level: 80, icon: PenTool, description: 'Advanced' },
    ],
    "Tools & Platforms": [
      { name: 'Git', level: 80, icon: Code, description: 'Advanced' },
      { name: 'MS Office', level: 85, icon: Code, description: 'Expert' },
      { name: 'Visual Studio Code', level: 85, icon: Code, description: 'Expert' },
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'About', 'Skills', 'Experience', 'Projects', 'Contact'].map((item) => (
                <button
                  ...
                  className={`nav-link interactive-hover text-sm font-medium transition-colors duration-300 ease-in-out hover:text-primary ${activeSection === item.toLowerCase() ? 'text-primary active' : 'text-muted-foreground'
                    }`}
                >
                  {item}
                </button>
            ...
            <div className="pt-4 pb-2 space-y-2 animate-[slideDown_0.3s_ease-out]">
              {['Home', 'About', 'Skills', 'Experience', 'Projects', 'Contact'].map((item) => (
                <button
                  ...
                  className={`block w-full text-left py-2 px-4 rounded-lg transition-colors ${activeSection === item.toLowerCase()
      ...
      <section id="skills" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20 animate-fade-in">
            ...
            <div className="cursor-highlight p-4 rounded-xl" onMouseMove={handleSkillsMouseMove}>
              <p className="section-subtitle max-w-3xl mx-auto">



                Programming Languages:  <span className="text-primary font-semibold"> Java, JavaScript, Python, TypeScript, C++</span><br />
                Web Technologies: <span className="text-primary font-semibold">HTML, CSS, RESTful APIs, JSP/Servlets, Responsive Design</span><br />
                Frameworks & Libraries: <span className="text-primary font-semibold">React, Redux, Spring Boot, Tailwind CSS, Bootstrap</span><br />
                Design & Creative: <span className="text-primary font-semibold">Adobe Photoshop, Canva, UI/UX Design, Graphic Design, Figma</span><br />
                Content Creation: <span className="text-primary font-semibold">Content Writing, Social Media Management, Video Editing, Digital Marketing, SEO Blogging</span><br />
                Tools & Platforms: <span className="text-primary font-semibold">Git, GitHub, Visual Studio Code, Eclipse, MS Office</span><br />
      ...
      <section id="contact" className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <Card className="card-enhanced fade-in-up bg-card relative z-20 pointer-events-auto">
              <CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4 no-cursor-effect">
                  ...
                  <Button type="submit" className="btn-enhanced w-full" disabled={isSubmitting}>
                    {isSubmitting ? (
                      <>
